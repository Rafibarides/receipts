...
/** Plain category names. The few duplicates across claim groups get a short qualifier. */
const CATEGORIES = [
  'Restaurants',
  'Takeout',
  'Groceries (above normal spending)',
  'Food delivery fees',
  ...
  'Kitchen supplies',
  'Small appliances',
  'Furniture (temporary housing)',

  'Laundromat',
  'Dry cleaning',
  'Smoke or soot cleaning of clothing',
  'Cleaning supplies',
  ...
  'Tarping',
  'Water removal',
  'Emergency electrician or plumber',
  'Locksmith',
  ...
  'Electronics (lost in fire)',
  'Clothing (lost in fire)',
  'Appliances (lost in fire)',
  'Kitchenware (lost in fire)',
  'Music or photography equipment (lost in fire)',
  'Other destroyed belongings',

  'Replacement identification',
  'Passport or birth-certificate fees',
  'Printing, postage, and shipping',
  'Notary fees',
  'Copies of records',

  'Temporary school-related expenses',

  'Temporary workspace',
  'Replacement work equipment',
  'Internet installation',
  'Equipment rental',
  'Lost or damaged business inventory'
];
